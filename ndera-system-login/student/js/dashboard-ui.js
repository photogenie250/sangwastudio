...
function renderNotifications() {
  ...
  if (likesState && !likesState.eligible) {
    ...
    items.push({
      warning: false,
      title: 'Likes Nshya',
      body: `Wahawe like ${likesState.count} kubera imyitwarire myiza.`,
    });
  }
  ...
  // Red dot specifically for an unseen announcement (more urgent/
  // eye-catching than the default blue used for the other,
  // state-based notification types below).
  bellDot.classList.toggle('dash-dot--announce', newAnnouncements.length > 0);
