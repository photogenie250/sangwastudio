// ============================================================
// Parent portal — inactivity auto-logout
//
// Watches for user activity (mouse, keyboard, touch, scroll) and
// calls onTimeout() once none of it has happened for `timeoutMs`.
// Used on the dashboard to sign a parent out automatically if the
// tab is left open and unattended (e.g. on a shared/school device).
// ============================================================
...
export function startInactivityLogout({ timeoutMs = 5 * 60 * 1000, onTimeout }) {
  ...
  // way the parent can't see, and re-checks it once they're back.
