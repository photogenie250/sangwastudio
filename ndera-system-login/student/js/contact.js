...
(function prefillFromQuery() {
  ...
  if (studentNumber) form.student_number.value = studentNumber;
})();
...
form.addEventListener('submit', async (event) => {
  ...
  successBox.textContent = payload.student_number
    ? 'Usabiye umunyeshuri uruhushya. Subira ku ipaji y\'umunyeshuri kugira ngo urebe igisubizo.'
    : 'Usabiye umunyeshuri uruhushya urabimenyeshwa kuri telephone.';
