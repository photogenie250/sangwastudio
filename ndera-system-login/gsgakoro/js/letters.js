...
// Resolved against this page's own URL rather than hardcoded, so it
// keeps working no matter what domain or subpath the site is
// deployed under. Needs to be a full, absolute URL (not a relative
// one) because this same markup is also dropped into outgoing HTML
// emails, which have no "current page" to resolve a relative path
// against.
const NDERA_LOGO_URL = new URL('../assets/img/ndera-logo.svg', window.location.href).href;
  ...
  return `
    <div class="letter-paper">
      <div class="letter-letterhead">
        <img src="${NDERA_LOGO_URL}" alt="NDERA SYSTEM" class="letter-logo">
        <div>
