...
// event to DOD over Telegram via the Telegram Bot API. Nothing in this file
// talks to Telegram or holds any Telegram bot credential — the alert
...
// (and shown to DOD on Telegram) — separate from the friendly, vague
...
// ------------------------------------------------------------
// Attempt logging → triggers the Telegram alert server-side.
