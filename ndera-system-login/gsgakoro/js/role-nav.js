...
//   and like a student for good behavior, and both of those live
//   right on the Students page (open a student's profile, then
//   use the panels there) — so a teacher has no reason to see any
//   other page. Their sidebar shows only "Students", and if they
//   load (or link-hop, or type in the address bar) anything else,
//   applyRoleNav sends them straight back to it.
//
