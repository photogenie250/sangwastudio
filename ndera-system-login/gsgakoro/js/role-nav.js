...
// - teacher: scoped to the Students page and the Dashboard. The
//   only things a teacher account can do are remove marks (record
//   an incident) and like a student for good behavior, and both of
//   those live right on the Students page (open a student's
...
//   access. Their sidebar shows only "Dashboard" and "Students",
//   and if they load (or link-hop, or type in the address bar)
//   anything else, applyRoleNav sends them straight back to
//   Students.
//
...
const TEACHER_ALLOWED_HREFS = ['../students/', '../dashboard-admin/'];
