...
// request to DOD over Telegram via the Telegram Bot API. Nothing here talks
...
form.addEventListener('submit', async (event) => {
  ...
  const payload = {
    ...
    student_number: form.student_number.value.trim() || null,
  ...
  successBox.textContent = payload.student_number
    ? 'Ubusabe bwoherejwe! DOD arabimenya kuri Telegram. Igisubizo muzagisanga kuri porogaramu y\'umunyeshuri.'
    : 'Ubusabe bwoherejwe! DOD arabimenya kuri Telegram.';
