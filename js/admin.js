...
(function () {
  ...
  let isAdmin = false; // only admins can delete articles — checked against public.profiles
  ...
  async function saveArticle(targetStatus) {
    ...
    if (!id) {
      // Record who published this article (used to restrict deletion to admins).
