...
/* ---------- Mobile drawer (legacy burger pattern, still used by Ndera pages) ---------- */
(function(){
...
/* ---------- Mobile drawer (slide-in panel, matches Gakoro Media TV's pattern) ---------- */
(function(){
  ...
  window.addEventListener('resize', () => {
    ...
    resizeTimer = setTimeout(() => {
      if (window.innerWidth > 720 && drawer.classList.contains('open')) closeDrawer();
    }, 150);
  });
})();
