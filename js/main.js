...
/* ---------- WhatsApp helper links ---------- */
function waLink(text){
  const number = window.WHATSAPP_NUMBER || "250780000000";
  return `https://wa.me/${number}?text=${encodeURIComponent(text)}`;
}
document.getElementById('waFloat').href = waLink("Hello SANGWA STUDIO! I'd like to know more about your services.");
document.getElementById('waFooterLink').href = waLink("Hello SANGWA STUDIO! I'd like to know more about your services.");
...
orderForm.addEventListener('submit', async (e) => {
  ...
  // on WhatsApp automatically via a Supabase Database Webhook + Edge
  // Function — see README section 3. The customer never sees WhatsApp.
