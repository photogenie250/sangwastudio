...
(function () {
  ...
  function renderArticle(a) {
    ...
    main.innerHTML = `
      ...
      <!-- Placeholder ad slot — empty/invisible until configured.
           See README.md "Monetization" to drop in a real AdSense
           <ins class="adsbygoogle"> unit here once approved. -->
      <div class="ad-slot" id="inArticleAdSlot"></div>
