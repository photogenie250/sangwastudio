/* =====================================================
   ...
   hero copy + grid cards on index.html with real
   titles, thumbnails and stats. (The 3 cards beside the
   player show latest articles now — see js/latest-articles.js.)
...
(function () {
  ...
  // NOTE: the 3 cards in #heroSection .side-card are no longer video
  // cards — they now show the latest articles (see js/latest-articles.js).
