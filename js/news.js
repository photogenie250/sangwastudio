...
(function () {
  ...
  function applyTickerSpeed() {
    ...
    // A narrow (mobile) viewport shows far less of the ticker track at
    // once, so the same px/sec scroll speed reads as much faster than on
    // desktop. Give mobile noticeably more time per headline to compensate.
    const isNarrow = window.innerWidth <= 640;
    const SECONDS_PER_HEADLINE = isNarrow ? 4.5 : 2.5;
    const MIN_DURATION = isNarrow ? 22 : 14;
    const MAX_DURATION = isNarrow ? 38 : 25;
